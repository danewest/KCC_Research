...
if __name__ == "__main__":
    ...
    try:
        ...
        df = load_data("Test Data/GRDR_processed.csv")

        X_train, X_test, y_train, y_test, test_df = train_test_split(df, "UTCTimestampCollected", "2023-03-27", "2024-03-27", "2024-05-27")
        ...
        df = load_data("Test Data/WOOD_processed.csv")

        X_train, X_test, y_train, y_test, test_df = train_test_split(df, "UTCTimestampCollected", "2024-03-11", "2025-03-11", "2025-05-11")
